...
import dungeonmania.entities.logicals.logicalEntities.*;
import dungeonmania.entities.logicals.conductors.*;
...
public class EntityFactory {
    ...
    public Sceptre buildSceptre() {
        int mindControlDuration = config.optInt("mind_control_duration", 1);
        return new Sceptre(mindControlDuration);
    }

    public MidnightArmour buildMidnightArmour() {
        double midnightArmourAttack = config.optInt("midnight_armour_attack", 0);
        double midnightArmourDefence = config.optInt("midnight_armour_defence", 0);
    ...
    private Entity constructEntity(JSONObject jsonEntity, JSONObject config) {
        ...
        String logic = jsonEntity.optString("logic");
        ...
        switch (jsonEntity.getString("type")) {
            ...
            case "bomb":
                ...
                if (logic.isEmpty())
                    ...
                    return new LogicalBomb(pos, bombRadius, logic);
